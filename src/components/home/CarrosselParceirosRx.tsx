...
const IMG_1 = '/parceiros-carrossel/parceiros-desktop-01.webp';
const IMG_2 = '/parceiros-carrossel/parceiros-desktop-02.webp';
const IMG_3 = '/parceiros-carrossel/parceiros-desktop-03.webp';
...
const CarrosselParceirosRx = () => {
  ...
  return (
    <div className="w-full overflow-hidden pt-4 pb-10 md:pt-14 md:pb-14 relative flex flex-col gap-6 md:gap-10 [mask-image:linear-gradient(to_right,transparent,black_10%,black_90%,transparent)] [-webkit-mask-image:linear-gradient(to_right,transparent,black_10%,black_90%,transparent)]">
...
export default CarrosselParceirosRx;
